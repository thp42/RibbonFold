...
def make_atom14_positions(protein):
    ...
    alternative_gt_positions = torch.einsum(
        "...rac,...rab->...rbc", residx_atom14_gt_positions, renaming_transform.double()    # add .double here, or an unbelievable error will occur
    )
    ...
    alternative_gt_mask = torch.einsum(
        "...ra,...rab->...rb", residx_atom14_gt_mask.float(), renaming_transform.float()       # add .double here, or an unbelievable error will occur
    )
...
#@curry1       # will return function, will not use it
